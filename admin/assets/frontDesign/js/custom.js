$(document).ready(function() {
    ...
    //MEGA MENU	
    $(".dep-menu").hover(function() {
        $(".dep-mm").fadeIn();
    });
    $(".dep-menu").mouseleave(function() {
        $(".dep-mm").fadeOut();
    });
    ...
    $(".infra-menu").hover(function() {
        $(".infra-mm").fadeIn();
    });
    $(".infra-menu").mouseleave(function() {
        $(".infra-mm").fadeOut();
    });
    ...
    $(".iqac-menu").hover(function() {
        $(".iqac-mm").fadeIn();
    });
    $(".iqac-menu").mouseleave(function() {
        $(".iqac-mm").fadeOut();
    });
    //MEGA MENU	
