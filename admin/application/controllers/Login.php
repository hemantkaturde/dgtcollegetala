...
class Login extends BaseController
{
    ...
    // ================================
    public function getStateData($country_id = NULL)
    {
       $record['state'] = $this->login_model->getStateData($country_id);
       echo json_encode($record);
    }
   //  =====
   public function getDistrictData($state_id = NULL)
   {
       $record['dist'] = $this->login_model->getDistrictData($state_id);
       echo json_encode($record);        
   }
   //  =====
   public function getCityData($state_id = NULL, $dist_id)
   {
       $record['city'] = $this->login_model->getCityData($state_id,$dist_id);
       echo json_encode($record);        
   }
    // =================================
}
