<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <small>Upload Backup Logme Process</small>
        </h1>
    </section>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="optionfilebackup" name="optionfilebackup">
                                                        <option value="0">Choose a Spare</option>
                                                        <?php
                                            if(!empty($backups))
                                            {
                                            ...
                                            ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <p class="help-block">For backup installation, you need to select backup from server or Select file.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
