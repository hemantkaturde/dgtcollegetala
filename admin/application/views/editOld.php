                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control required" id="user_name" value="<?php echo $user_name;?>" name="user_name"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="password" placeholder="Password" value=<?php echo $password;?> name="password" maxlength="20">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="cpassword">Confirm Password</label>
                                            <input type="text" class="form-control" id="cpassword" placeholder="Confirm Password" value=<?php echo $password;?> name="cpassword" maxlength="20">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
