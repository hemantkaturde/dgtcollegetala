...
<body>
    ...
    <div class="wrapper" style="background : url('<?php echo base_url(); ?>assets/images/bg1.jpg')">
        
    <div class="login">
    <div class="login-decoration">
            <img src="<?php echo base_url(); ?>assets/images/ParcelBhejLogin.png" height="450px;">
          </div>
    <div class="login-form">      
        ...
        <?php } ?>
              ...
              <form action="<?php echo base_url(); ?>loginMe" method="post">
                  <label class="label" for="email" style="color:#fff">Email Address</label>
